describe("place_order", () => {
  it("tests place_order", () => {
    ...
    cy.get("#tbodyid > div:nth-child(1) > div > div > h5").then(($link) => {
      productPrice = $link.text().substr(1);
    });
    ...
    // fill field 'Credit card' with value '12345678890798798798798798798798798798789789'
    cy.get("#card").invoke(
      "val",
      "12345678890798798798798798798798798798789789"
    );
